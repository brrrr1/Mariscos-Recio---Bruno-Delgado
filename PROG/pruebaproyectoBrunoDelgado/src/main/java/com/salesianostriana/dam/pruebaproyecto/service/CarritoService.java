...
public class CarritoService {
	/*
	 * @Autowired PedidoService sevicioPedido;
	 * 
	 ...
	 * carrito.addLineaDePedido(LineaDePedido.builder() .producto(producto)
	 * .cantidad(cantidad) .build() ); }else { Optional <LineaDePedido> lp =
	 * buscarPorProducto(usuario, producto);
	 * 
	 ...
	 * 
	 * private Optional<LineaDeVenta> buscarPorProducto(Usuario usuario, Producto
	 * producto) {
	 * 
	 * Pedido carrito = getCarrito(usuario); }
	 */
